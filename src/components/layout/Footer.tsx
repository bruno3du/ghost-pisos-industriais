    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 max-w-6xl py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Fornecendo soluções de piso premium para instalações industriais desde 2005.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/services/floor-coatings" className="text-gray-400 hover:text-white">
                  Revestimentos de Piso
                </Link>
              </li>
              <li>
                <Link href="/services/floor-markings" className="text-gray-400 hover:text-white">
                  Marcações de Piso
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-sm text-gray-400 text-center">
          <p>&copy; {new Date().getFullYear()} Soluções em Piso Industrial. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
