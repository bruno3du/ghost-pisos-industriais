...
export const metadata: Metadata = {
  ...
  description: "Veja nosso portfólio de projetos de pisos industriais concluídos, incluindo pisos epóxi, concreto polido e reparos de piso.",
};
  ...
  const projects = [
    {
      ...
      category: "Piso Epóxi",
      description: "Instalação de um sistema de piso epóxi resistente a produtos químicos para uma instalação de fabricação de 4.645 m².",
    ...
    },
    {
      ...
      description: "Piso de concreto polido para um centro de distribuição de 9.290 m² com tráfego intenso de empilhadeiras.",
    ...
    },
    {
      ...
      category: "Piso Epóxi",
      description: "Sistema de piso epóxi compatível com normas sanitárias para uma instalação de produção de alimentos com propriedades antimicrobianas.",
    ...
    },
    {
      ...
      description: "Reparo extensivo de concreto e preenchimento de juntas para uma fábrica de manufatura automotiva.",
      location: "Betim, MG",
      year: 2022,
    ...
    },
    {
      ...
      category: "Piso Epóxi",
      description: "Instalação de um sistema de piso epóxi para sala limpa para uma instalação de fabricação farmacêutica.",
    ...
    },
    {
      ...
      description: "Sistema abrangente de marcação de piso para um centro logístico de 6.968 m² para melhorar a segurança e a eficiência.",
    ...
    <main className="flex min-h-screen flex-col items-center py-24">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <p className="text-xl text-gray-600 mb-12 text-center max-w-3xl mx-auto">
          Veja nossos projetos de piso industrial concluídos para conhecer exemplos do nosso trabalho
          em várias indústrias e aplicações.
        </p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div key={project.id} className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition">
